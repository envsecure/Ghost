...
async function setOnboardingState(page: Page, checklistState: ChecklistState, completedSteps: string[] = [], startedAt: string | null | undefined = checklistState === 'started' ? new Date().toISOString() : undefined) {
...
async function startOnboarding(page: Page) {
    ...
    await page.goto('/ghost/#/setup/onboarding?returnTo=%2Fanalytics');
